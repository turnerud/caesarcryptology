...
def DecodeCaesar():
    ...
    list_of_original_chars = list(plainText);
    ...
    for x in list_of_cipher_chars:
        ...
        if x in alphabet:
            ...
            while match == False:
                ...
                if alphabet[(index_of_cipher_char - shiftNumber) % 26] == list_of_original_chars[elementNumber]:
            ...
            while match == False:
                ...
                if upperAlphabet[(index_of_cipher_char - shiftNumber) % 26] == list_of_original_chars[elementNumber]:                
    ...
    print("Your probable shift is ", shiftNumber);
